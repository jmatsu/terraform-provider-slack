...
resource "slack_channel" "new" {
    name = "zz_terraform_example_channel_new"
}

resource "slack_group" "new" {
    name = "zz_terraform_example_group_new"
}

resource "slack_channel" "managed" {
    name = "zz_terraform_example_channel_managed"
    purpose = "change here"
}

resource "slack_group" "managed" {
    name = "zz_terraform_example_group_managed"
    purpose = "change here"
}
